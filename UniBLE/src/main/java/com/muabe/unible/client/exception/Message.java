...
public enum Message {
    ...
    SCAN_FAILED(9, "스캔 실패"),
    BT_BOND_FAILED (10, "페어링 실패"),
    BT_STATE_OFF(11, "블루투수가 비활성화됨"),
    BT_NOT_ENABLE(12, "블루투스가 활성화되지 않아 명령을 실행할수 없음"),
    ALEADY_CONNECTED(13, "기기에 이미 연결되어 있습니다."),
    ALEADY_CONNECTING(14, "이미 연결 중입니다."),
    CONNECTION_FAILED(15,  "연결에 실패 하였습니다.");
